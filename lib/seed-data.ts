...
const legacyDashboardPipeline: Pipeline = {
  ...
  progressPercent: 66,
  phases: [
    { name: "explore", displayName: "Explore", status: "done", assignedLabel: "FE", durationLabel: "✓ 8m" },
    { name: "propose", displayName: "Propose", status: "done", assignedLabel: "FE", durationLabel: "✓ 6m" },
    { name: "spec", displayName: "Spec", status: "done", assignedLabel: "Arch", durationLabel: "✓ Daniel ✓" },
    { name: "design", displayName: "Design", status: "done", assignedLabel: "Sonnet", durationLabel: "✓ 14m" },
    { name: "implement", displayName: "Implement", status: "blocked", assignedLabel: "FE + BE", durationLabel: "⚠ review" },
    { name: "verify", displayName: "Verify", status: "pending", assignedLabel: "QA", durationLabel: "queued" },
    { name: "archive", displayName: "Archive", status: "pending", assignedLabel: "Docs", durationLabel: "—" },
  ],
};
...
const legacyAuthPipeline: Pipeline = {
  ...
  progressPercent: 82,
  phases: [
    { name: "explore", displayName: "Explore", status: "done", assignedLabel: "BE", durationLabel: "✓ 10m" },
    { name: "propose", displayName: "Propose", status: "done", assignedLabel: "BE", durationLabel: "✓ 7m" },
    { name: "spec", displayName: "Spec", status: "done", assignedLabel: "Arch", durationLabel: "✓ Daniel ✓" },
    { name: "design", displayName: "Design", status: "done", assignedLabel: "Opus", durationLabel: "✓ 22m" },
    { name: "implement", displayName: "Implement", status: "done", assignedLabel: "BE", durationLabel: "✓ 1h 14m" },
    { name: "verify", displayName: "Verify", status: "blocked", assignedLabel: "SEC", durationLabel: "⚠ 2 findings" },
    { name: "archive", displayName: "Archive", status: "pending", assignedLabel: "Docs", durationLabel: "—" },
  ],
};
